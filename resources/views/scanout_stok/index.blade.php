...
@section('contents')
    @push('scripts')
        ...
        <script>
            ...
            function redirectToEdit() {
                const reportId = document.getElementById('id_report').value.trim();
                if (reportId) {
                    window.location.href = "{{ route('scan.edit.report.out', ':id') }}".replace(':id', encodeURIComponent(reportId));
                } else {
                    alert('Harap masukkan Report Number');
                }
            }
    ...
    <div class="container">
        <div class="card p-2 p-md-4 mt-4 shadow-lg">
            <!-- Form Packing -->
            <form action="{{ route('scan.outstok') }}" method="POST" id="stoForm">
                @csrf
                <div class="mb-2">
        ...
        <div class="card p-2 p-md-4 mt-4 shadow-lg">
            <!-- Form Search -->
            <form action="{{ route('scan.searchout') }}" method="GET" id="searchForm">
                <div class="mb-2">
